...
def viewtodo(request,todo_pk):
    ...
    if request.method=='GET':
        ...
        try:
            ...
            return render(request,'todo/viewtodo.html',{'todo':todo,'form':form,'error':'There is error'})
@login_required
...
def loginuser(request):
    ...
    if request.method =='GET':
        ...
        if user is None:
            return render(request,'todo/loginuser.html',{'form':AuthenticationForm(),'error':'User doesnt match'})
